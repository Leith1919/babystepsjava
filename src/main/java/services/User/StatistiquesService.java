...
public class StatistiquesService {
    ...
    public Map<String, Integer> getDelaiRendezVous(LocalDate debut, LocalDate fin) {
        ...
        resultats.put("1-2 sem", 0);
        resultats.put("Plus 2 sem", 0);
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    if (delai <= 1) {
                        ...
                        resultats.put("1-2 sem", resultats.get("1-2 sem") + total);
                    } else {
                        resultats.put("Plus 2 sem", resultats.get("Plus 2 sem") + total);
                    }
                }
            }
        } catch (SQLException e) {
