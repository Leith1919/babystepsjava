...
public class OrdonnanceServices implements IServices<Ordonnance> {
    ...
    @Override
    public void supprimerD(Ordonnance ordonnance) throws SQLException {

    }

    @Override
    public List<Ordonnance> afficherDisponibilite() throws SQLException {
        return List.of();
    }

    @Override
    public void modifierD(Ordonnance ordonnance) throws SQLException {
