...
public class AjoutSuiviBebeController {
    ...
    @FXML private TextField poidsBebeField;
    @FXML private TextField tailleBebeField;
    @FXML private ComboBox<String> etatSanteComboBox;
    @FXML private TextField battementCoeurField;
    @FXML private ComboBox<String> appetitBebeComboBox;
    @FXML private Button enregistrerButton;
    @FXML private Label titreFormulaire;

    // Labels d'erreur pour chaque champ
    @FXML private Label dateErreurLabel;
    @FXML private Label poidsErreurLabel;
    @FXML private Label tailleErreurLabel;
    @FXML private Label santeErreurLabel;
    @FXML private Label battementErreurLabel;
    @FXML private Label appetitErreurLabel;
    ...
    public void enregistrerSuiviBebe(ActionEvent actionEvent) {
        try {
            ...
            if (modeModification) {
                ...
                showAlert(Alert.AlertType.INFORMATION, "Succès", "Suivi Bébé mis à jour avec succès !");
            } else {
                suiviBebeService.ajouter(sb);
                showAlert(Alert.AlertType.INFORMATION, "Succès", "Suivi Bébé ajouté avec succès !");
            }

            // Fermer le formulaire et rafraîchir le tableau IMMÉDIATEMENT
            if (parentController != null) {
                // Exécuter directement sans délai
                Platform.runLater(() -> {
                    System.out.println("Fermeture du formulaire et rafraîchissement du tableau");
