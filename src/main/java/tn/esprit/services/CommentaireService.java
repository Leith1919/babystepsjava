...
public class CommentaireService {
    ...
    public void ajouter(Commentaire c) throws SQLException {
        // Vérifier si le commentaire est impoli avant de l'ajouter
        if (isCommentaireImpoli(c)) {
            // Envoi d'un email pour alerter l'administrateur
            String subject = "Alerte : Commentaire impoli détecté";
            String body = "Un commentaire impoli a été laissé sur l'article : " + c.getArticleId() +
                    "\n\nContenu du commentaire : " + c.getCommentaire();
