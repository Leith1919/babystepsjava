...
public class MailUtil {
    ...
    private static final String USERNAME = "8b47e4001@smtp-brevo.com";
    private static final String PASSWORD = "64QXIPSAKhgyBvMW";
    ...
    public static boolean sendPasswordResetMail(String toEmail, String verificationCode) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress("babystepsjava@gmail.com"));
